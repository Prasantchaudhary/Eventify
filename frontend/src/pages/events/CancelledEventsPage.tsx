...
export const CancelledEventsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Cancelled Events</h1>
        <p className="mt-2 text-gray-600">Events that were cancelled</p>
      </div>
      ...
      {events.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">No events are cancelled at the moment.</p>
        </div>
      )}
    </div>
  );
